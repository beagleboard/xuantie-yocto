...
IMAGE_INSTALL += " apache2 iperf3 libgpiod libgpiod-tools nano python3-crcmod python3-cryptography python3-evdev python3-idna python3-jmespath python3-pip python3-requests python3-setuptools python3-six python3-urllib3 python3-wheel "
