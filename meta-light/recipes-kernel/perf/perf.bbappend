...
PERF_SRC_URI_5_10_y = " \
            file://0001-Fix-too-few-arguments-to-function-init_disassemble_i.patch \
"

SRC_URI:append = "${@bb.utils.contains('PREFERRED_VERSION_linux-thead', '5.10.y', '${PERF_SRC_URI_5_10_y}', '', d)}"
