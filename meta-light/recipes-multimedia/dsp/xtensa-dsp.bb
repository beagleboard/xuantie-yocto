...
SRC_URI = " \
            git://github.com/thead-yocto-mirror/xtensa_dsp.git;branch=master;protocol=https \
...
CFLAGS:append = " -I${PKG_CONFIG_SYSROOT_DIR}/usr/include/vidmem/"
LDFLAGS:append = " -L${PKG_CONFIG_SYSROOT_DIR}/usr/lib/ -lvmem"
...
FILES:${PN} += " ${includedir} "
PACKAGES = "${PN}"
INSANE_SKIP:${PN} += " debug-files already-stripped dev-deps file-rdeps arch ldflags"
# PACKAGES = " "
